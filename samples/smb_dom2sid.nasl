...
if (description)
{
 ...
 script_set_attribute(attribute:"synopsis", value:"It is possible to obtain the domain SID.");
...
if(! d)
  exit(0, 'The scan policy is not configured to request domain informaiton. ' +
