...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote system can be accessed with a default password.");
...
Note that Junos Space is known to use these credentials by default.");
  script_set_attribute(attribute:"see_also", value:"http://kb.juniper.net/InfoCenter/index?page=content&id=KB26220");
